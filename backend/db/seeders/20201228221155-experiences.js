...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Experiences', [
      {title: "Bartending class", description: "Learn how to mix fancy drinks like: \n\n-Moscow Mule\n-Cranberry Orange Mimosas\n-Perfect Lemon Martini\n-Irish Creme Drink\n\nIf you won't learn anything you'll drink anyway and have fun!", max: 1, duration: 180, currentPrice: 350, locationId: 1, hostId: 2, imageUrl:"/img/wine-tasting.jpg"},
      {title: "Wine tasting", description: "Not as much of tasting but more of drinking in a very fancy church basement.", max: 2, duration: 120, currentPrice: 300, locationId: 2, hostId: 2, imageUrl:"/img/bartending.jpg"},

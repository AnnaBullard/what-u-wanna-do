...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Bookings', [
      ...
      {experienceId: 1, date: new Date("2021-01-01 20:00:00+00"), dateWithTimeZone: new Date("2021-01-01 20:00:00-08"), price: 350, userId:1, statusId: 2, rate: null},
      ...
      {experienceId: 1, date: new Date("2021-01-09 13:00:00+00"), dateWithTimeZone: new Date("2021-01-09 13:00:00-08"), price: 350, userId:3, statusId: 2, rate: null},
      ...
      {experienceId: 3, date: new Date("2021-02-20 12:00:00+00"), dateWithTimeZone: new Date("2021-02-20 12:00:00-08"), price: 80, userId:3, statusId: 2, rate: null},
      ...
      {experienceId: 5, date: new Date("2021-01-08 17:00:00+00"), dateWithTimeZone: new Date("2021-01-08 17:00:00-05"), price: 180, userId:2, statusId: 2, rate: null},
